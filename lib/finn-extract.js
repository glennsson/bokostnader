...
async function extractFromPage(page) {
  ...
  return { fromEmbedded, fromText, fromSalgsoppgave };
}
...
export async function extractFinnListing(url) {
  ...
  let { fromEmbedded, fromText, fromSalgsoppgave } = page
    ? await extractFromPage(page)
    : { fromEmbedded: { found: false }, fromText: { found: false }, fromSalgsoppgave: null };
